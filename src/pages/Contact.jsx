    ...
    <>
      ...
      <section className="pt-16 pb-20">
        <Container>
          ...
          >
            <div className="relative px-6 sm:px-8 md:px-12 pt-14 pb-8 sm:py-12 sm:max-w-md">
              <h2 className="font-sans text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-bold text-text-on-light mb-3 sm:mb-4 max-sm:translate-y-5">
                Get in Touch
              </h2>
              <p className="text-sm sm:text-lg md:text-xl text-text-on-light/80 leading-relaxed max-sm:max-w-[14rem]">
